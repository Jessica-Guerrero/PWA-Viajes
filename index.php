...
<body>
    ...
    <section class="ftco-about d-md-flex" id="about">
        ...
        <div class="one-half ftco-animate">
            ...
            <div>
                <p>
                    Roses es la agencia de viaje líder en Latinoamérica. Tus boletos de avión, paquetes de viaje y
                    hoteles están en Roses, crucial para tener así las mejores vacaciones. <br> Le asesoraremos paso
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">Roses🌞</h2>
